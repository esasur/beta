...
@Component({
  templateUrl: 'build/pages/events-list-2/events-list-2.html',
...
export class EventsList2 {
  ...
  private themes: any = [];
  private id_theme: any = '';
  private subvention_vd: any = '';
  


  constructor(private events: MikiEventsService, private mikiPerson: MikiPersonService, private mikiPublicite: MikiPubliciteService, private e: Events, private loadingCtrl: LoadingController, private navParams: NavParams, private nav: NavController) {
    // this.presentLoading();
  ...
  eventClick(event, item) {
    this.nav.rootNav.push(EventDetails, {
