...
var MikiPersonService = (function () {
    function MikiPersonService(platform, http, events) {
        var _this = this;
        ...
        platform.ready().then(function () {
            ...
            _this.storage = new ionic_angular_1.Storage(ionic_angular_1.LocalStorage);
        });
    ...
    MikiPersonService.prototype.setPushToken = function (pushToken) {
        ...
        var datas = {
            pushToken: pushToken,
            pushDevice: ionic_native_1.Device.device.platform
        };
        var params = 'params=' + JSON.stringify(datas);
        var headers = new http_1.Headers();
        headers.append('Content-Type', 'application/x-www-form-urlencoded');
    ...
    MikiPersonService = __decorate([
        core_1.Injectable(), 
        __metadata('design:paramtypes', [ionic_angular_1.Platform, http_1.Http, ionic_angular_1.Events])
    ], MikiPersonService);
    return MikiPersonService;
}());
exports.MikiPersonService = MikiPersonService;
