...
var MikiPubliciteService = (function () {
    function MikiPubliciteService(platform, http) {
        var _this = this;
    ...
    MikiPubliciteService = __decorate([
        core_1.Injectable(), 
        __metadata('design:paramtypes', [ionic_angular_1.Platform, http_1.Http])
    ], MikiPubliciteService);
    return MikiPubliciteService;
}());
exports.MikiPubliciteService = MikiPubliciteService;
